...
export class SupplierService extends Service {
  constructor(protected client: HttpClient) {
    super();
    this.model = "supplier";
    this.url = environment.APP_FILE_SERVER_URL + environment.toApi?.supplier;
  ...
  //   let obj = Supplier.builder().fromSerialized(object.value);
  //   const body = Supplier.builder().toSerialized(obj);
